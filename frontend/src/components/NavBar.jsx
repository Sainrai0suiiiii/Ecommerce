...
const NavBar = () => {
  ...
  return (
    <div className="flex items-center justify-between py-5 font-medium">
      <Link to ='/'><img onClick ={() =>setShowSearch(true)} src={assets.style_street_logo} className="w-36" alt="" /></Link>
        ...
        <div className="group relative">
          ...
          <div className="group-hover:block hidden absolute dropdown-menu right-0 pt-4">
            <div className="flex flex-col gap-2 w-26 py-3 bg-slate-100 text-gray-500 rounded">
              <Link to="/profile" className="cursor-pointer px-3 py-1 hover:text-black">My Profile</Link>
              <Link to="/orders" className="cursor-pointer px-3 py-1 hover:text-black">Orders</Link>
              <p className="cursor-pointer px-3 py-1 hover:text-black">Logout</p>
            </div>
          </div>
        </div>
